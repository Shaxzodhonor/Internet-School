...
const Index = () => {
  ...
  const [imageChild, setImageChild] = useState(false)
  const [listFile, setListFile] = useState(0)

  useEffect(() => {
    request.get("/employee/type/6").then(data => {
      if(data.status === 200) {
            ...
            <div className="modal-body">
              <form onSubmit={SubmitForm} className='border border-1 border-dark bg-white rounded p-5'>           
                <div className='row g-3'>                
                  ...
                  <div className="col">
                    <label className="form-label">Kimligini ko'rsating</label>
                  ...
                  <div className="col">
                    <label className="form-label">Diplom / Fahriy yorliq (mavjud bo'lsa)</label>
          ...
          <div className="modal-content">
            ...
            <form onSubmit={Edit} className='border border-1 border-dark bg-white rounded p-5'>
                  ...
                  ? 
                    ...
                    (
                      <div className='my-3'>
                        ...
                        <button type='button' className='mt-3 btn btn-danger' onClick={()=> setImageChild(true)}>Yangi rasm Tanlash</button>
                      </div>
                    )
                }
                </div>
              ...
              <div className='row'>
                ...
                <div className="col-4">
                  <div className="mb-3">
                    <label className="form-label">Kimligini tanlang</label>
              ...
              <div className="row">
                ...
                <div className="col">
                  <div className="mb-3">
                    <label className="form-label">additionalni tanlang</label>
